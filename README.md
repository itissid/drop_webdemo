...
The demo is a PoC of productization to explore and travel in urban going ons and how to present them in an almost meditative in the moment manner. It is location and time centric: You can find the things happening around you now or later. I have utilized AI (LLMs), OpenRouteService, FastAPI and K8s for building it.
